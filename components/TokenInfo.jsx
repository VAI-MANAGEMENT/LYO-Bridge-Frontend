        ...
        <>
            {tokenData ?
                <div className="card-container mb-4">
                    <h3>Token Info</h3>
                    <div className="d-flex justify-content-between align-items-center gap-2 info-wrp"><span className="d-flex justify-content-between align-items-center gap-2"><Image src={logoSmall} width="25" height="25" /> <strong>LYOTRADE</strong> (LYO)  $ {(parseFloat(tokenData.high)).toFixed(2)}</span><a href="https://www.lyotrade.com/en_US/trade/LYO_USDT" target="_blank" rel="noreferrer" className="align-items-center d-flex"><Image src={lyotradeLogo} width="25" height="25" /> <BsArrowUpRightSquare/></a></div>
